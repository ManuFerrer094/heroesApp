  ...
  onSubmit(): void {
    ...
    if (this.currentHero.id) {
      this.heroesService.updateHero(this.currentHero)
        .subscribe(hero => {
          ...
          this.showNotification('Error updating hero', 'Close');
        });
      return;
    }
    ...
    this.heroesService.addHero(this.currentHero)
      .subscribe(hero => {
        ...
        this.showNotification('Error creating hero', 'Close');
      });
  }
  ...
  onDeleteHero() {
    ...
    dialogRef.afterClosed()
      ...
      .subscribe((wasDeleted: boolean) => {
        if (wasDeleted) {
          this.showNotification('Hero deleted successfully', 'Close');
          this.router.navigate(['/heroes']);
        } else {
          this.showNotification('Error deleting hero', 'Close');
        }
      });
  }
